...
shinyUI(dashboardPage(skin = "black",
                      ...
                      dashboardHeader(title = "MEM dashboard",
                                      tags$li("23MAY2017, code under GPLv2 at",
                                              class = "dropdown"),
                      ...
                      dashboardSidebar(width='250px', 
                                       ...
                                       bsPopover(id = "file", title = "Load file",      content = "memapp is able to read text, excel, access and R.",                                   placement = "top", trigger = "hover", options = list(container = "body")),
                                       box(title="Dataset", status = "warning", solidHeader = FALSE, width = 12, background = "navy", collapsible = TRUE, collapsed=FALSE,
                                           ...
                                           bsPopover(id = "dataset", title = "Select dataset", content = "If the format is able to store different datasets, select the one you want to open.", placement = "top", trigger = "hover", options = list(container = "body")),
                                           ...
                                           bsPopover(id = "firstWeek", title = "First week", content = "First week of the datasets` surveillance period.",                                    placement = "top", trigger = "hover", options = list(container = "body")),
                                           ...
                                           bsPopover(id = "lastWeek", title = "Last week", content = "Last week of the datasets surveillance period.",                                     placement = "top", trigger = "hover", options = list(container = "body")),
                                           ...
                                           bsPopover(id = "transformation", title = "Transform data", content = "Select the transformation to apply to the original data.",                            placement = "top", trigger = "hover", options = list(container = "body"))
                                       ),
                                       ################################
                                       ###    Model                ####
                                       ################################
                                       box(title="Model", status = "primary", solidHeader = TRUE, width = 12,  background = "black", collapsible = TRUE, collapsed=TRUE,
                                           ...
                                           bsPopover(id = "SelectFrom", title = "Select seasons for the model", content = "First column to include in the model selection.", placement = "top", trigger = "hover", options = list(container = "body")),
                                           selectInput("SelectTo", h6(tags$style(type = "text/css", "#q1 {vertical-align: top;}"), "To"), size=1, selectize = FALSE, choices = ""),
                                           bsPopover(id = "SelectTo", title = "Select seasons for the model", content = "Last column to include in the model selection.", placement = "top", trigger = "hover", options = list(container = "body")),
                                           selectInput('SelectExclude', h6(tags$style(type = "text/css", "#q1 {vertical-align: top;}"), "Exclude"), multiple = TRUE, choices = NULL),
                                           bsPopover(id = "SelectExclude", title = "Select seasons for the model", content = "Select any number of seasons to be excluded from the model.", placement = "top", trigger = "hover", options = list(container = "body")),
                                       ...
                                       box(title="Surveillance", status = "primary", solidHeader = TRUE, width = 12, background = "black", collapsible = TRUE, collapsed=TRUE,
                                           ...
                                           bsPopover(id = "SelectSurveillance", title = "Current season", content = "Season you want to use for surveillance applying the MEM thresholds.<br>This season can be incomplete.<br> It is recommended not to use the surveillance season in the model selection.", placement = "top", trigger = "hover", options = list(container = "body")),
                                           ...
                                           bsPopover(id = "SelectSurveillanceWeek", title = "Surveillance week", content = "Week you want to create the surveillance graph for. It can be any week from the first week of the surveillance season to the last one that have data", placement = "top", trigger = "hover", options = list(container = "body")),
                                           ...
                                           bsPopover(id = "SelectSurveillanceForceEpidemic", title = "Epidemic start", content = "Chose a week to force the start of the epidemic period.<br>The epidemic will start at the week selected and not at the first week over the epidemic threshold.", placement = "top", trigger = "hover", options = list(container = "body"))
                                       ),
