...
#### Paths ####
#-----------------------------------------------------------------------------------
script.path <- "G:/Projekt/Biostatistik/Projekt 2015/P15045 - AnnaSara Carnehan (Influensalarm)/Script/Pandemia_app_20170126"
...
## Applikation Shiny
runApp(file.path(script.path), launch.browser=TRUE)
