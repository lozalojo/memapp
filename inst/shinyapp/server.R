...
shinyServer(function(input, output, session) {
  ...
  observeEvent(input$firstWeek, {
    ...
    if (!is.null(datfile)){
      ...
      cat("observe/firstWeek> updating manual optimization plots\n")
      selectedcolumns<-select.columns(i.names=names(datfile), i.from=input$SelectFrom, i.to=input$SelectTo,
                                      i.exclude=input$SelectExclude, i.include="",
                                      i.pandemic=T,
                                      i.seasons=as.numeric(input$SelectMaximum))
  ...
  observeEvent(input$lastWeek, {
    ...
    if (!is.null(datfile)){
      ...
      cat("observe/lastWeek> updating manual optimization plots\n")
      selectedcolumns<-select.columns(i.names=names(datfile), i.from=input$SelectFrom, i.to=input$SelectTo,
                                      i.exclude=input$SelectExclude, i.include="",
                                      i.pandemic=T,
                                      i.seasons=as.numeric(input$SelectMaximum))
  ...
  observeEvent(input$dataset, {
    ...
    if (!is.null(datfile)){
      ...
      cat("observe/dataset> updating manual optimization plots\n")
      selectedcolumns<-select.columns(i.names=names(datfile), i.from=input$SelectFrom, i.to=input$SelectTo,
                                      i.exclude=input$SelectExclude, i.include="",
                                      i.pandemic=T,
                                      i.seasons=as.numeric(input$SelectMaximum))
