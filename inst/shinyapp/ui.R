...
shinyUI(
  dashboardPage(
    ...
    ### HEADER SECTION              ###
    ###################################
    # Tricky way of placing elements in dashboardHeader, expects a tag
    # element of type li and class dropdown, so we can pass such
    # elements instead of dropdownMenus
    ...
    ###################################
    body = dashboardBody(
      # All credits of the busy-indicator goes to AnalytixWare/ShinySky,
      # I was forced to include the code here because the package does
      # not have a CRAN release.
        ...
        column(
          ...
          dropdown(
            shinydashboard::box(
              ...
              uiOutput("uiLanguage"),
              selectInput("language", label = "", choices = languages_list, size = 1, selectize = FALSE, selected = defaultLanguage()),
